...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        Role roleUser = createRoleIfNotFound("ROLE_PROFESSEUR");
        ...
        for (int i = 1; i < 50; i++) {
            createUserIfNotFound("utilisateur" + i + "@gmail.com", "utilisateur" + i, "utilisateur" + i, "utilisateur" + i, "utilisateur" + i, userRoles);
        }
        //endregion
