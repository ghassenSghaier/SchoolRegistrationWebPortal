...
import com.ghassen.spring.domain.UserRepository;
...
public class UserService {
    ...
    public User findByIdEagerly (Long id){
     ...
     public List<User> findByCandidatureEagerly (Long id){
        return userRepository.findByCandidatureEagerly(id);
    }
    ...
    public User createNewAccount(UserDto userDto) {
        ...
        user.setRoles(Collections.singletonList(roleService.findByName("ROLE_PROFESSEUR")));
        return user;
    }
